...
#define INTERRUPT_0  __interrupt
...
extern void udelay (unsigned char usecs);
// delay for approximately msecs milliseconds
extern void mdelay (unsigned short msecs);

extern void EZUSB_Delay1us(void) _naked;
#define SYNCDELAY EZUSB_Delay1us()
...
#define EZUSB_IRQ_ENABLE()   EIUSB = 1
#define EZUSB_IRQ_DISABLE()   EIUSB = 0
...
extern void modify_endpoint_stall(BYTE epid, BYTE stall) _naked;
